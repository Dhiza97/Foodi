  ...
  return (
    <div>
      <div className="drawer sm:drawer-open">
        ...
        <div className="drawer-content flex flex-col sm:items-start sm:justify-start my-2 text-black">
          {/* Page content here */}
          <div className="flex items-center justify-between mx-4">
            ...
            <button className="btn rounded-full px-6 bg-green flex items-center gap-2  text-white border-none sm:hidden">
              <FaRegUser /> Logout
            </button>
          </div>
        ...
        <div className="drawer-side">
          ...
          ></label>
          <ul className="menu bg-gray-300 text-secondary text-base-content min-h-full w-80 p-4">
