    ...
    return (
        <div className='section-container my-20 bg-white relative'>
            ...
            <div className='md:absolute right-5 top-8 mb-10 md:mr-24'>
                <button onClick={() => slider?.current?.slickPrev()} className='btn p-2 rounded-full ml-5 bg-white border-none'>
                    <FaAngleLeft className='w-8 h-8 p-1 text-black hover:text-white'/>
                </button>
                <button onClick={() => slider?.current?.slickNext()} className='btn p-2 rounded-full ml-5 bg-green border-none'>
                    <FaAngleRight className='w-8 h-8 p-1 text-black hover:text-white'/>
                </button>
            </div>
